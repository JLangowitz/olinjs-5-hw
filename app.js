...
app.configure(function(){
  ...
  app.use(express.cookieParser('c9bc977d47820b4c225533cebc8cc902'));
  app.use(express.session());
  app.use(Facebook.middleware({ appId: '141713195991282', secret:'c9bc977d47820b4c225533cebc8cc902'}))
  app.use(app.router);
